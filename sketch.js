...
var imagemArco, imagemFlecha, imagem_balaoVerde, imagem_balaoVermelho, imagem_balaoRosa ,imagem_balaoAzul, imagemPlanoFaundo;
var pontuacao = 0
var balaoRosaG
var grupoFlechas
var balaoVermG
...
function setup() {
  ...
  arco.scale = 1;
  balaoRosaG = new Group()
  grupoFlechas = new Group()
  balaoVermG = new Group()
  balaoAzuG = new Group()
  balaoVerdeG = new Group()
...
function draw() {
 background(0);
  ...
  if(balaoRosaG.isTouching(grupoFlechas)){
    pontuacao = pontuacao +1
    balaoRosaG.destroyEach()
    grupoFlechas.destroyEach()
  }
  if(balaoVermG.isTouching(grupoFlechas)){
        pontuacao = pontuacao +1
      balaoVermG.destroyEach()
        grupoFlechas.destroyEach()

  }
    if(balaoAzuG.isTouching(grupoFlechas)){
          pontuacao = pontuacao +1
        balaoAzuG.destroyEach()
          grupoFlechas.destroyEach()

    }
  if(balaoVerdeG.isTouching(grupoFlechas)){
        pontuacao = pontuacao +1
        balaoVerdeG.destroyEach()
        grupoFlechas.destroyEach()
